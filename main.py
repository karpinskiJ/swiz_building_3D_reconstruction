...
class Sfm():
    def __init__(self, img_dir:str) -> None:
        self.img_obj = Image_loader(img_dir)
    ...
    def find_keypoints(self, image_0, image_1) -> tuple:
    ...
    def run(self, enable_bundle_adjustment=False):
        ...
        feature_0, feature_1 = self.find_keypoints(image_0, image_1)
        ...
        for i in tqdm(range(total_images)):
            ...
            features_cur, features_2 = self.find_keypoints(image_1, image_2)
